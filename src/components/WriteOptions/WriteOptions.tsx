        ...
        return (
                <>
                        ...
                        <div className="flex flex-wrap justify-left" role="group">
                                {WriteLength.map((e) => (
                                        <div key={e.TagName} className="py-1"> {/* Correct placement of the key prop */}
                                                <button
                        ...
                        <div className="flex justify-center my-4">
                                <button onClick={handleSendForm} disabled={!props.text.trim()} className={`p-3 w-9/12 rounded-full transition ${props.text.trim() ? 'bg-violet-500 hover:bg-violet-600' : 'bg-violet-300'} text-white`}>
                                        Regenerate Crtl
                                </button>
                        </div>
                </>
